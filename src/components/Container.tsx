...
const Container: FC<ContainerProps> = ({className}) => {
    ...
    return (
        ...
        <div className='flex flex-col mt-10 items-center gap-20'>
            ...
            <Project 
                className='p-4 lg:w-1/2 w-9/12 flex flex-col items-center  rounded-3xl bg-emerald-100 bg-opacity-15  hover:animate-pulseScale' 
                title='Te chiflo'
            ...
            />
            <Project 
                className='text-center p-4 lg:w-1/2 w-9/12 flex flex-col items-center rounded-3xl bg-emerald-100 bg-opacity-15 hover:animate-pulseScale' 
